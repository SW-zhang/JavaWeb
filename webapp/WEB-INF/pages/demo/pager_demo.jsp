...
<div class="block-white-m">
    <table class="table table-across-border table-page">
        ...
        <tbody>
            <c:forEach items="${pager.results}" var="demo">
                <tr>
                    <td>${demo.name}</td>
    ...
    <page:outpage pageSize="${pager.pageSize}" params="${pageParam }" totalPage="${pager.totalPages}"
          curPage="${pager.currentPage }" url="${ctx}/demo/list_page"/>
</div>
