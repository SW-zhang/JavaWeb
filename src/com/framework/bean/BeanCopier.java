...
abstract public class BeanCopier {
    ...
    private static final Type BEAN_COPIER = TypeUtils.parseType("framework.bean.BeanCopier");
    ...
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) {
            ...
            ce.begin_class(Opcodes.V1_2, Opcodes.ACC_PUBLIC, getClassName(), BEAN_COPIER, null, Constants.SOURCE_FILE);
